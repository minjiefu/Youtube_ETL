...
def insert_rows(cur, conn, schema, row):
    ...
    try:
        ...
        if schema == "staging":
            ...
            video_id = "video_id" # for 最后一行的logging purpose
            ...
            video_id = "Video_ID"  
            # the core layer read data from the staging layer, so match the names with staging layer table's column names
            cur.execute(
                f"""
...
def delete_rows(cur, conn, schema, ids_to_delete):
    ...
    try:
        ...
        # 把python list:[id1,id2,id3]转换成SQL的IN语句需要的格式：('id1', 'id2', 'id3')
