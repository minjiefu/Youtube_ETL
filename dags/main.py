...
# Define the local timezone  https://timezonedb.com/time-zones
...
# Define the DAG：https://airflow.apache.org/docs/apache-airflow/stable/core-concepts/dags.html#declaring-a-dag
# DAG 1: produce_json
with DAG(
    dag_id="produce_json",
